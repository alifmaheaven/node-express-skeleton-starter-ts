...
} from '../interfaces/SeverityInterfaces';

import PaginationInterfaces from '../interfaces/PaginationInterfaces';

@Route('/api/v1/severity')
@Tags('Severity')
export default class SeverityController extends Controller {
  @Security('bearer')
  @Get('/')
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: SeverityCreateInterfaces,
  ): Promise<SeverityInterfaces> {
    const DB_NAME = 'severity';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: SeverityUpdateInterfaces,
  ): Promise<SeverityInterfaces> {
    const DB_NAME = 'severity';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: SeverityDeleteInterfaces,
  ): Promise<SeverityInterfaces> {
    const DB_NAME = 'severity';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
      @Body() requestBody: SeverityUploadDeleteInterfaces,
  ): Promise<any> {
