...
export default class StatusController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: StatusCreateInterfaces,
  ): Promise<StatusInterfaces> {
    const DB_NAME = 'status';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: StatusUpdateInterfaces,
  ): Promise<StatusInterfaces> {
    const DB_NAME = 'status';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: StatusDeleteInterfaces,
  ): Promise<StatusInterfaces> {
    const DB_NAME = 'status';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: StatusUploadDeleteInterfaces,
  ): Promise<any> {
