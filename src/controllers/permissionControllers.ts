...
export default class PermissionController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: PermissionCreateInterfaces,
  ): Promise<PermissionInterfaces> {
    const DB_NAME = 'permission';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: PermissionUpdateInterfaces,
  ): Promise<PermissionInterfaces> {
    const DB_NAME = 'permission';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: PermissionDeleteInterfaces,
  ): Promise<PermissionInterfaces> {
    const DB_NAME = 'permission';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: PermissionUploadDeleteInterfaces,
  ): Promise<any> {
