...
} from '../interfaces/SiteInterfaces';
...
export default class SiteController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: SiteCreateInterfaces,
  ): Promise<SiteInterfaces> {
    const DB_NAME = 'site';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: SiteUpdateInterfaces,
  ): Promise<SiteInterfaces> {
    const DB_NAME = 'site';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: SiteDeleteInterfaces,
  ): Promise<SiteInterfaces> {
    const DB_NAME = 'site';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: SiteUploadDeleteInterfaces,
  ): Promise<any> {
