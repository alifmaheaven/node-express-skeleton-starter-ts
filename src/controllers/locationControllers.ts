...
export default class LocationController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: LocationCreateInterfaces,
  ): Promise<LocationInterfaces> {
    const DB_NAME = 'location';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: LocationUpdateInterfaces,
  ): Promise<LocationInterfaces> {
    const DB_NAME = 'location';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: LocationDeleteInterfaces,
  ): Promise<LocationInterfaces> {
    const DB_NAME = 'location';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
      @Body() requestBody: LocationUploadDeleteInterfaces,
  ): Promise<any> {
