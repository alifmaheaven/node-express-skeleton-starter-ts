...
} from '../interfaces/AttendanceInterfaces';
...
export default class AttendanceController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: AttendanceCreateInterfaces,
  ): Promise<AttendanceInterfaces> {
    const DB_NAME = 'attendance';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: AttendanceUpdateInterfaces,
  ): Promise<AttendanceInterfaces> {
    const DB_NAME = 'attendance';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: AttendanceDeleteInterfaces,
  ): Promise<AttendanceInterfaces> {
    const DB_NAME = 'attendance';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: AttendanceUploadDeleteInterfaces,
  ): Promise<any> {
