...
export default class UsersController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: UsersCreateInterfaces,
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: UsersUpdateInterfaces,
  ): Promise<UsersInterfaces> {
    const DB_NAME = 'users';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: UsersDeleteInterfaces,
  ): Promise<UsersInterfaces> {
    const DB_NAME = 'users';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: UsersUploadDeleteInterfaces,
  ): Promise<any> {
