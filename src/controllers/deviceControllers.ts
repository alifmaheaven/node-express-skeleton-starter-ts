...
export default class DeviceController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: DeviceCreateInterfaces,
  ): Promise<DeviceInterfaces> {
    const DB_NAME = 'device';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: DeviceUpdateInterfaces,
  ): Promise<DeviceInterfaces> {
    const DB_NAME = 'device';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: DeviceDeleteInterfaces,
  ): Promise<DeviceInterfaces> {
    const DB_NAME = 'device';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: DeviceUploadDeleteInterfaces,
  ): Promise<any> {
