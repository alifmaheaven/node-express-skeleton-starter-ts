...
export default class ContractController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: ContractCreateInterfaces,
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: ContractUpdateInterfaces,
  ): Promise<ContractInterfaces> {
    const DB_NAME = 'contract';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: ContractDeleteInterfaces,
  ): Promise<ContractInterfaces> {
    const DB_NAME = 'contract';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: ContractUploadDeleteInterfaces,
  ): Promise<any> {
