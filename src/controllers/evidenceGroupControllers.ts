...
import {
  EvidenceGroupInterfaces,
  EvidenceGroupCreateInterfaces,
  EvidenceGroupUpdateInterfaces,
  EvidenceGroupDeleteInterfaces,
  EvidenceGroupFilterInterfaces,
  EvidenceGroupUploadDeleteInterfaces,
} from '../interfaces/EvidenceGroupInterfaces';

import PaginationInterfaces from '../interfaces/PaginationInterfaces';

@Route('/api/v1/evidenceGroup')
@Tags('EvidenceGroup')
export default class EvidenceGroupController extends Controller {
  @Security('bearer')
  @Get('/')
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: EvidenceGroupCreateInterfaces,
  ): Promise<EvidenceGroupInterfaces> {
    const DB_NAME = 'evidence_group';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: EvidenceGroupUpdateInterfaces,
  ): Promise<EvidenceGroupInterfaces> {
    const DB_NAME = 'evidence_group';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: EvidenceGroupDeleteInterfaces,
  ): Promise<EvidenceGroupInterfaces> {
    const DB_NAME = 'evidence_group';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: EvidenceGroupUploadDeleteInterfaces,
  ): Promise<any> {
