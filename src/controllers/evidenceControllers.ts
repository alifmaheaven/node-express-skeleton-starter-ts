...
@Tags('Evidence')
export default class EvidenceController extends Controller {
  @Security('bearer')
  @Get('/')
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: EvidenceCreateInterfaces,
  ): Promise<EvidenceInterfaces> {
    const DB_NAME = 'evidence';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: EvidenceUpdateInterfaces,
  ): Promise<EvidenceInterfaces> {
    const DB_NAME = 'evidence';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: EvidenceDeleteInterfaces,
  ): Promise<EvidenceInterfaces> {
    const DB_NAME = 'evidence';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: EvidenceUploadDeleteInterfaces,
  ): Promise<any> {
