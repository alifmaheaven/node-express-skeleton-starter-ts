...
import {
  ServiceInterfaces,
  ServiceCreateInterfaces,
  ServiceUpdateInterfaces,
  ServiceDeleteInterfaces,
  ServiceFilterInterfaces,
  ServiceUploadDeleteInterfaces,
...
export default class ServiceController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: ServiceCreateInterfaces,
  ): Promise<ServiceInterfaces> {
    const DB_NAME = 'service';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: ServiceUpdateInterfaces,
  ): Promise<ServiceInterfaces> {
    const DB_NAME = 'service';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: ServiceDeleteInterfaces,
  ): Promise<ServiceInterfaces> {
    const DB_NAME = 'service';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: ServiceUploadDeleteInterfaces,
  ): Promise<any> {
