...
export default class RoleController extends Controller {
  ...
  public async createData(
    @Request() req: any,
    @Body() requestBody: RoleCreateInterfaces,
  ): Promise<RoleInterfaces> {
    const DB_NAME = 'role';
  ...
  public async updateData(
    @Request() req: any,
    @Body() requestBody: RoleUpdateInterfaces,
  ): Promise<RoleInterfaces> {
    const DB_NAME = 'role';
  ...
  public async deleteData(
    @Request() req: any,
    @Body() requestBody: RoleDeleteInterfaces,
  ): Promise<RoleInterfaces> {
    const DB_NAME = 'role';
    const { id } = requestBody;
  ...
  public async deleteFile(
    @Request() req: any,
    @Body() requestBody: RoleUploadDeleteInterfaces,
  ): Promise<any> {
